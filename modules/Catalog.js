...
const createJobCareer = () => {
    ...
    for (const history of historiesJson) {
        ...
        jobContentHTML.append(`<p class="detailTitle">業務内容</p>`);
        jobContentHTML.append(`<div><p>${history.jobContents}</p></div>`);
...
const histories = [
    {
        ...
        "jobContents":
            "基本設計～結合テスト、保守運用、調査、ルーティンの自動化（VBA）、新人の方のコーディング指導<br>" +
            "・新規機能の製造は４画面、３帳票、バッチ５本を担当。<br>" +
            "・保守運用：アプリの障害対応、既存不良の解消、顧客依頼の修正作業等。<br>" +
            "・製造範囲：WebUI、サーバ・バッチ処理、SQL<br>"
    },
    {
    ...
    },
    {
        ...
        "jobContents":
            "詳細設計、コーディング<br>" +
            "・リプレイス：abap言語（SAP）の仕様を調べながらjavaへ翻訳。<br>" +
            "・コーディング：２機能担当（10,000 Step）。<br>"
    },
    {
        ...
        "jobContents":
            "調査、ツール製造、結合テスト<br>" +
            "・ツール製造：VBA, powerShell を使用し、顧客の業務効率を改善した。<br>" +
            "・リプレイス：フレームワークの置き換え（struts to spring）。<br>" +
            "・調査：フレームを置き換えた影響により障害が発生しており、原因を調査。<br>"
    },
    {
        "historyTitle": "WEBアプリ（新規立ち上げ、既存アプリの改修・障害対応）",
        ...
        "jobContents":
            "要求分析～結合テスト、保守<br>" +
            "・VB.NETで作成された既存アプリに対し、機能の追加や改修を行った。<br>" +
            "・WEBアプリ（案件管理用）を新規に作成。WebUI、サーバ処理、DB処理、サーバの構築などを行った。<br>" +
    ...
    },
    {
        ...
        "jobContents":
            "java, postgreSQL, HTML, Servlet, JSP の基本を学習。<br>" +
            "最終課題のチームによるアプリ制作では、詳細設計～実装を担当した。<br>" +
            "実装についてはほぼ一人で担う。<br>" +
            "帰宅後、休日もひたすらコーディングに打ち込んでいた。<br>"
    },
    {
        ...
        "jobContents":
            "税務会計、決算・申告、監査、経理作業、巡回訪問<br>" +
            "VBAを使用した業務効率化（業後、休暇を利用し在職中に習得）<br>"
    },
    {
